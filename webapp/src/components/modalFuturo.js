...
<div id="myModalFuturo" className="modal fade" role="dialog">
        ...
        <div className="table-responsive">
          ...
          <table className="table table-bordered table-hover table-condensed">
            <thead className="fontSizeHeader">
              <tr>
                <th>Nemo</th>
                <th> Nemotécnico del Subyacente</th>
                <th>P. Actual</th>
                <th>P. Anterior</th>
                <th>% Var.</th>
            </tr>
            ...
            <tbody className="fontSizeDetail">
              { details.map((detail) =>
                <tr key={detail.detalleConsulta.idDetalle} className={cls({'alert alert-danger': detail.variacion.alerta, 'alert alert-info': typeof detail.variacion.precioActual == "undefined"})}>
                  <td>{detail.detalleConsulta.nemotecnico}</td>
                  <td>{detail.detalleConsulta.nemotecnicoSubyacente}</td>
