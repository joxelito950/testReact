import {
    ...
    validacionFallida, tableDynamicParametroPortafolio, ejecutarValorFondo, showProcessNavs, listarValorFondo,
...
import {
    ...
    OBTENER_CRG_OPER_TRD_AJST, OBTENER_CRG_OPERACIONES_TRD, OBTENER_CRG_OPERACIONES_REP, OBTENER_CRG_OPERACIONES_COLL,
    OBTENER_CRG_OPERACIONES_CMAT, OBTENER_CRG_AJT_OPE_CMAT, OBTENER_CRG_OP_AJS_SPOT, OBTENER_CRG_VEN_OPER,
    OBTENER_CRG_VEN_CASHWF, OBTENER_CRG_VEN_WEEK, OBTENER_CRG_VEN_PAY_FAILS, OBTENER_CRG_VEN_EVENTOS,
    OBTENER_CRG_FIXING, OBTENER_AJS_VENCIM, OBTENER_VAL_OPCT, OBTENER_VAL_OPCT_TTVRV, OBTENER_VAL_OPCT_TTVRF,
...
describe('test de obtenerListaProcesoCurvas', () => {
    it('No debe ingresar a ningun type y retornar el valor enviado', () => {
        expect(obtenerListaProcesoCurvas('state', 'actions'))
            .toEqual('state');
    });
